...
public abstract class FluidIngredient {
   ...
   */
  public abstract Collection<FluidStack> getFluids();
  ...
  public void write(PacketBuffer buffer) {
    ...
    for (FluidStack stack : fluids) {
      buffer.writeString(stack.getFluid().getRegistryName().toString());
  ...
  private static class FluidMatch extends FluidIngredient {
    ...
    public JsonElement serialize() {
      ...
      object.addProperty("fluid", fluid.getRegistryName().toString());
